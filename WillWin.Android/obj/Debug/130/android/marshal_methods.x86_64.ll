...
@assembly_image_cache_hashes = local_unnamed_addr constant [190 x i64] [
	...
	i64 566579994377380837, ; 6: WillWin.Android => 0x7dce580c5b4e3e5 => 0
	...
	i64 1711350285197082516, ; 23: WillWin => 0x17bff0046b6f7f94 => 23
	...
	i64 6591024623626361694, ; 82: System.Web.Services.dll => 0x5b7805f9751a1b5e => 93
	...
	i64 8684531736582871431, ; 103: System.IO.Compression.FileSystem => 0x7885a79a0fa0d987 => 91
	...
	i64 9854531567039444819, ; 112: WillWin.Android.dll => 0x88c2543fa9427753 => 0
	...
	i64 11023048688141570732, ; 119: System.Core => 0x98f9bc61168392ac => 14
	...
	i64 11739066727115742305, ; 129: SQLite-net.dll => 0xa2e98afdf8575c61 => 8
	i64 11806260347154423189, ; 130: SQLite-net => 0xa3d8433bc5eb5d95 => 8
	i64 12102847907131387746, ; 131: System.Buffers => 0xa7f5f40c43256f62 => 13
	i64 12137774235383566651, ; 132: Xamarin.AndroidX.VectorDrawable => 0xa872095bbfed113b => 72
	i64 12279246230491828964, ; 133: SQLitePCLRaw.provider.e_sqlite3.dll => 0xaa68a5636e0512e4 => 12
	...
	i64 12550732019250633519, ; 138: System.IO.Compression => 0xae2d28465e8e1b2f => 90
	...
	i64 14792063746108907174, ; 155: Xamarin.Google.Guava.ListenableFuture.dll => 0xcd47f79af9c15ea6 => 83
	i64 14852515768018889994, ; 156: Xamarin.AndroidX.CursorAdapter.dll => 0xce1ebc6625a76d0a => 40
	i64 14987728460634540364, ; 157: System.IO.Compression.dll => 0xcfff1ba06622494c => 90
	...
	i64 15499339074737679461, ; 160: WillWin.dll => 0xd718b6c4fb122c65 => 23
	...
	i64 16565028646146589191, ; 166: System.ComponentModel.Composition.dll => 0xe5e2cdc9d3bcc207 => 92
	...
	i64 16822611501064131242, ; 170: System.Data.DataSetExtensions => 0xe975ec07bb5412aa => 89
	...
	i64 17285063141349522879, ; 175: Rg.Plugins.Popup => 0xefe0e158cc55fdbf => 7
	...
	i64 17827832363535584534, ; 179: Xamarin.Forms.PancakeView.dll => 0xf7692f1427c04d16 => 78
	i64 17838668724098252521, ; 180: System.Buffers.dll => 0xf78faeb0f5bf3ee9 => 13
	...
	i64 18370042311372477656, ; 188: SQLitePCLRaw.lib.e_sqlite3.android.dll => 0xfeef80274e4094d8 => 11
...
@assembly_image_cache_indices = local_unnamed_addr constant [190 x i32] [
	i32 44, i32 5, i32 34, i32 66, i32 7, i32 67, i32 0, i32 53, ; 0..7
	i32 85, i32 47, i32 11, i32 43, i32 88, i32 80, i32 94, i32 82, ; 8..15
	i32 10, i32 29, i32 2, i32 12, i32 27, i32 55, i32 48, i32 23, ; 16..23
	i32 16, i32 28, i32 66, i32 25, i32 54, i32 59, i32 32, i32 43, ; 24..31
	i32 93, i32 51, i32 19, i32 38, i32 71, i32 20, i32 24, i32 21, ; 32..39
	i32 6, i32 63, i32 19, i32 77, i32 82, i32 50, i32 26, i32 18, ; 40..47
	i32 69, i32 68, i32 17, i32 20, i32 86, i32 65, i32 44, i32 16, ; 48..55
	i32 9, i32 84, i32 73, i32 31, i32 24, i32 68, i32 79, i32 76, ; 56..63
	i32 57, i32 58, i32 78, i32 71, i32 70, i32 37, i32 14, i32 75, ; 64..71
	i32 35, i32 63, i32 52, i32 80, i32 3, i32 9, i32 53, i32 51, ; 72..79
	i32 32, i32 41, i32 93, i32 47, i32 22, i32 18, i32 49, i32 46, ; 80..87
	i32 22, i32 77, i32 76, i32 1, i32 87, i32 27, i32 92, i32 50, ; 88..95
	i32 89, i32 4, i32 36, i32 62, i32 70, i32 4, i32 61, i32 91, ; 96..103
	i32 75, i32 28, i32 17, i32 38, i32 58, i32 5, i32 35, i32 88, ; 104..111
	i32 0, i32 94, i32 1, i32 41, i32 69, i32 39, i32 29, i32 14, ; 112..119
	i32 21, i32 74, i32 40, i32 64, i32 74, i32 49, i32 25, i32 86, ; 120..127
	i32 46, i32 8, i32 8, i32 13, i32 72, i32 12, i32 45, i32 56, ; 128..135
	i32 42, i32 33, i32 90, i32 34, i32 85, i32 2, i32 72, i32 36, ; 136..143
	i32 83, i32 30, i32 65, i32 87, i32 45, i32 79, i32 33, i32 59, ; 144..151
	i32 64, i32 52, i32 57, i32 83, i32 40, i32 90, i32 42, i32 39, ; 152..159
	i32 23, i32 55, i32 15, i32 67, i32 81, i32 15, i32 92, i32 37, ; 160..167
	i32 62, i32 10, i32 89, i32 6, i32 26, i32 60, i32 48, i32 7, ; 168..175
	i32 31, i32 56, i32 54, i32 78, i32 13, i32 3, i32 81, i32 91, ; 176..183
	i32 30, i32 60, i32 84, i32 61, i32 11, i32 73 ; 184..189
], align 16
